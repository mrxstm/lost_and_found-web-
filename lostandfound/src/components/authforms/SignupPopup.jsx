...
function SignupPopup({close, openLogin}) {
    ...
    return(
        <div className="bg-[#1f2937] p-4 w-[100%] flex flex-col mt-10">
                ...
                <button onClick={close} className='w-4 flex self-end'><img src={closecross} alt="" /></button>
                ...
                (errors) => {console.log(errors);
                    ...
                    <div className='mt-6'>
                        ...
                        <div>
                            ...
                            name="college" 
                            id="college" 
                            className='bg-[#111827] border border-[#9ca3af] w-full h-12 flex items-center gap-2 rounded-2xl mt-2 text-white px-4'
                            {...register("college")}
                            >
                    ...
                    <p className='flex gap-2 text-[#9ca3af] text-sm self-center mt-6'>Already have an account? <span className='text-[#5DCEA6] cursor-pointer' onClick={openLogin}>Sign in</span> </p>
                </form>
        </div>
    );
}
