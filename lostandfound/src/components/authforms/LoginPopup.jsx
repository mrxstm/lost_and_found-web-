...
function LoignPopup({close, openSignup}) {
        ...
        <div className="bg-[#1f2937] p-4 w-[100%] flex flex-col">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='flex items-center justify-between'>
                        <p className='flex gap-2 text-[#9ca3af] text-sm mt-6'>Don't' have an account? <span className='text-[#5DCEA6] cursor-pointer' onClick={openSignup}>Sign up</span> </p>
