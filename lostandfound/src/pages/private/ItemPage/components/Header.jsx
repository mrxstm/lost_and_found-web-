...
function Header() {
        ...
        const from = location.state?.from || "search"; // default to search
                
        // decide where to navigate and text dynamically
    ...
    return(   
        <div className="bg-[#1F2937] h-20 w-full z-50 fixed top-0 left-0 flex items-center px-12 gap-10">
            ...
            <h1 className="text-white text-2xl font-medium">{backText}</h1>
        </div>
    );
}
