...
function Header() {
    ...
    return (
        <div className="bg-[#1F2937] flex flex-col gap-4 h-60">
            ...
            <h1 className='text-2xl font-bold text-white ml-12 mt-2'>My Claims</h1>
            <p className="text-[#9ca3af] ml-12 text-sm">Track claims you've made and review claims on your reported items</p>
