...
function Reportform() {
   ...
   const handleImageChange = (e) => {
    ...
    return(
        <div className="bg-[#1F2937] h-[1400px] w-[900px] rounded-2xl text-[#9ca3af] p-6 mt-10">
            ...
            <form encType="multipart/form-data" onSubmit={handleSubmit(onSubmit, (errors)=> console.log(errors))}>
                <div className='mt-6'>
                    ...
                    <input id="itemname" {...register("itemname")} className="bg-[#111827] w-full outline-none border-none text-white"/>
                ...
                <div className="mt-4 flex gap-10 items-center justify-around ">
                    <div className="flex flex-col relative mt-2 w-1/2">
                            ...
                            />
                            <img src={calendar} alt="" className="size-4 absolute right-1/2 top-1/2 -translate-y-1/2" />
                            </div>
                ...
                <div className='mt-6'>
                    ...
                    <input type="text" id="description" {...register("description")} className="bg-[#111827] w-full outline-none border-none text-white"/>
